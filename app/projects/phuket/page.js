...
// Измени число 15 на количество твоих фото!
const photos = Array.from({ length: 16 }, (_, i) => ({
  id: i,
  url: `/photos/phuket/${i}.jpg`,
  alt: `Phuket ${i + 1}`
}));
    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <div className="pt-24 pb-8">
        <div className="max-w-7xl mx-auto px-8">
          <Link href="/projects" className="text-sm font-light hover:opacity-50 transition-opacity">
            ← Back to Projects
          </Link>
        </div>
      </div>
      ...
      <div className="pb-12">
        <div className="max-w-7xl mx-auto px-8">
          <h1 className="text-4xl font-light mb-4 tracking-wide">Phuket</h1>
          <p className="text-gray-600 font-light max-w-2xl">Tropical vibes and island life.</p>
        </div>
      </div>
