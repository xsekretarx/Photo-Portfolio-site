    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <div className="pb-12">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <p className="text-gray-600 font-light max-w-2xl">Analog moments captured on 35mm film. Exploring the streets with a vintage camera, embracing imperfections and the unique character of film photography.</p>
        </div>
      </div>
